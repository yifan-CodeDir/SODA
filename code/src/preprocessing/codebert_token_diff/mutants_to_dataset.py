...
def main(args, tokenizer):    
    ...
    map_src_to_dst((Macros.defects4j_root_dir / args.src_set / "test"), (Macros.defects4j_root_dir / args.dst_set / "test"), tokenizer)


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--model", type=str, choices=["codebert", "codet5"], default="codebert")
    parser.add_argument("--src_set", help="source set", default="base_set")
    parser.add_argument("--dst_set", help="dest set", default="codebert_token_diff")
