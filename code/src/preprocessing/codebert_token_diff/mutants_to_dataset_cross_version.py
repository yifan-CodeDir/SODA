...
if __name__ == "__main__":
    ...
    parser.add_argument("--src_set", help="source set", default="cross_version_base_set")  # Note that use the base set created by codet5
    parser.add_argument("--dst_set", help="dest set", default="cross_version_codebert_token_diff")
