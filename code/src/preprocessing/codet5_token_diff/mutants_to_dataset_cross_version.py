...
def main(args, tokenizer):    
    for proj_name, _ in Macros.train_versions.items():
        ...
        (Macros.defects4j_root_dir / args.dst_set / proj_name / "train_pos").mkdir(exist_ok=True, parents=True)
        ...
        map_src_to_dst((Macros.defects4j_root_dir / args.src_set / proj_name / "train_pos"), (Macros.defects4j_root_dir / args.dst_set / proj_name / "train_pos"), tokenizer)
