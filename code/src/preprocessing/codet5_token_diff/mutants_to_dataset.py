...
def main(args, tokenizer):    
    ...
    (Macros.defects4j_root_dir / args.dst_set / "train_pos").mkdir(exist_ok=True, parents=True) ###
    ...
    map_src_to_dst((Macros.defects4j_root_dir / args.src_set / "train_pos"), (Macros.defects4j_root_dir / args.dst_set / "train_pos"), tokenizer) ###
...
if __name__ == "__main__":
    ...
    parser.add_argument("--src_set", help="source set", default="codet5_base_set")
    parser.add_argument("--dst_set", help="dest set", default="codet5_token_diff")
