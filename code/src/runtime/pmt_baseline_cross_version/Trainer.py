...
class Trainer:
    def __init__(self, config, model_config, model, optimizer, criterion, dataloader, val_dataloader, start_epoch, experiment_id, project):
        self.config = config
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.start_epoch + 10000):
            ...
            }, os.path.join(Macros.defects4j_model_dir / self.config.experiment / self.project, f'epoch_{epoch}.pth.tar'))
