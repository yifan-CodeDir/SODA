...
"""
class TransSuite(nn.Module):
    def __init__(self, trans, embedding_dim, num_classes):
        super(TransSuite, self).__init__()
        self.trans = trans
    ...
    def forward(self, input_embeds, attention_mask):
        ...
        embeds = self.trans.forward(inputs_embeds=input_embeds, attention_mask=attention_mask)["pooler_output"]
